...
class VkBot:
    ...
    def __init__(self, user_id):
        ...
        self._COMMANDS = ["ПРИВЕТ", "ПОКА", "КОНВЕРТ", "КУРС", "HELP", "НАЧАТЬ", "БЛИЖ", "БАНК"]
        self.help = "Вас приветствует финансовый бот-помощник.\n" \
                    ...
                    "Если хотите узнать адрес ближайшего банкомата - напишите Банкомат"
    ...
    def new_message(self, message):
        ...
        # Пока
            ...
            return self.val
        elif self._COMMANDS[7] in message.upper() or self._COMMANDS[6] in message.upper():
            return "банкомат"
